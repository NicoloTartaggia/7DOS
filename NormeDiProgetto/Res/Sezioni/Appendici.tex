...
\subsubsection{\gl{Schedule Variance (SV)}}\Spazio
...
\subsubsection{\gl{Budget Variance (BV)}}\Spazio
...
\subsubsection{Numero rischi non previsti}\Spazio
...
\subsubsection{Media numero \gl{Build} \gl{Travis} a settimana}\Spazio
...
\subsubsection{Metriche per i prodotti software}\Spazio
