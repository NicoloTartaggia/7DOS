...
\subsubsection{Per la qualità del processo}
...
\paragraph{Media numero build Travis a settimana}\Spazio
...
\paragraph{Percentuale di build Travis superate}\Spazio
...
\subsubsection{Per la qualità del prodotto}
...
\subparagraph{Blocco di operazioni non corrette}\Spazio
...
\subparagraph{Percentuale di criticità corrette} \Spazio
