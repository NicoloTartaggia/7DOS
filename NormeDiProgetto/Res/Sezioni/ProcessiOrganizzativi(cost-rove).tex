...
\subsubsection{Metriche per la gestione del progetto}
\paragraph{\gl{Schedule Variance (SV)}} \Spazio
...
\paragraph{\gl{Budget Variance (BV)}} \Spazio
...
\paragraph{Numero rischi non previsti}\Spazio
