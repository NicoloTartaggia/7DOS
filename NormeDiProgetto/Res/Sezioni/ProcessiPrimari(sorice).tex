...
\subparagraph{GanttProject}\Spazio
...
\subparagraph{Microsoft Office}\Spazio
Infine, per l'attuale realizzazione dei consuntivi è stato deciso di utilizzare Microsoft Excel come strumento per creare i grafici, data la sua incredibile semplicità ma allo stesso tempo facilità di utilizzo.
