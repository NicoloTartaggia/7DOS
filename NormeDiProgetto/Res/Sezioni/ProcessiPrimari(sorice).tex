...
Per quanto concerne la gestione dei processi è stato deciso di utilizzare \gl{nTask}, data la sua comoda \gl{board view}, la possibilità di creare più feature anche nella versione gratuita, la possibilità di avere \gl{risk tracking} integrato e la creazione semi-automatica dei diagrammi di Gantt.
\subsubsection{Tracciamento dei requisiti}
Per quanto riguarda il tracciamento dei requisiti, il gruppo ha deciso di utilizzare inizialmente uno strumento non totalmente adatto a questo compito, cioè un foglio di calcolo. Essendo a conoscenza delle limitate funzionalità offerte da questa tecnologie per lo scopo a noi d'interesse, il team 7DOS ha deciso di migrare i dati raccolti in uno strumento creato appositamente per questo scopo. Lo strumento scelto è \gl{Trender} e rende il tracciamento dei requisiti semi-automatico, inoltre offre la creazione di file \gl{.tex} per il tracciamento dei requisiti.
\pagebreak
