...
\subparagraph{Media di build in travis per settimana}\Spazio
Media dei processi di build effettuati settimanalmente. Il calcolo viene effettuato automaticamente tramite un bot connesso a TravisCI.
