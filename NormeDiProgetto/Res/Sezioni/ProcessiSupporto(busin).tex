...
\subparagraph{Strumenti di supporto} \Spazio
Lo strumento usato per l'analisi dinamica è TravisCI, un servizio che permette di eseguire delle build automatiche su codice presente in repository GitHub. Tiene traccia dello storico delle build effettuate, mostrando per ognuna di esse varie informazioni tra cui l'esito, il commit che ha scaturito la build e l'utente che l'ha effettuato. Esso è facilmente integrabile con Coveralls, un servizio che permette di misurare la percentuale di codice coperto dai test. 
