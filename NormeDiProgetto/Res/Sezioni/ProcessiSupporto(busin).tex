...
Dal grafico si possono identificare in modo visuale, quindi generico e non numericamente quantificabile, dei dati sulla fase in esame ed osservarne la tendenza:
\begin{itemize}
...
\paragraph{Miglioramento del processo di verifia} \Spazio
