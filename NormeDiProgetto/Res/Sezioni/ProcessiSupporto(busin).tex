...
\begin{itemize}
	\item {\textbf{Test d'unità}: Verificano un unità, il più piccolo sottosistema possibile (nella programmazione ad oggetti comunemente una classe o od un metodo) che
