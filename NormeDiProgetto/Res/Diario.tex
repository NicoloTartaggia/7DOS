...
\section*{\centering{Diario delle modifiche}}
	\begin{longtable}{C{2cm}|C{2.5cm}|C{4.5cm}|C{2.5cm}|C{3cm}}
		...
		\hlineB{3}
		\endhead
		2.2.0 & 2019-02-07 & \emph{Metriche associate alle attività a cui riferiscono, per una maggiore coesione informativa } &  & Amministratore \\
		\hline
		
		2.2.0 & 2019-02-07 & \emph{Ampliamento §4.1 e §4.2} &  & Amministratore \\
		\hline
