...
\begin{itemize}
	...
	\item \textbf{Piano di Qualifica}: in questa attività l'Analista insieme al Responsabile di Progetto individua i metodi per garantire la \gl{qualità di prodotto}. Una volta individuati vengono redatti all'interno del documento Piano di Qualifica;
