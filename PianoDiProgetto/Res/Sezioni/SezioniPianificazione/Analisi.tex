...
\begin{itemize}
	...
	\item \textbf{Piano di Qualifica}: in questa attività l'\emph{Analista} insieme al \emph{Responsabile di Progetto} individua i metodi per garantire la \gl{qualità di prodotto}. Una volta individuati vengono redatti all'interno del documento Piano di Qualifica;
