...
Il prodotto da realizzare consiste in un plugin per il \gl{software} di monitoraggio \gl{Grafana}, da sviluppare in linguaggio \gl{JavaScript}. Il prodotto dovrà svolgere almeno le seguenti funzioni:
\begin{itemize}
