...
%------------------------
% Ho notato che gli altri gruppi hanno lasciato le seguenti sezioni identiche al piano di qualifica, se pensate vadano modificate in qualche modo mettiamoci d'accordo
%------------------------

\subsection{Scopo del prodotto}
Il prodotto da realizzare consiste in un \gl{plugin} per il \gl{software} di monitoraggio \gl{Grafana}, da sviluppare in linguaggio \gl{JavaScript}. Il prodotto dovrà svolgere almeno le seguenti funzioni:
\begin{itemize}
...
Tutto ciò che riguarda la pianificazione degli incrementi, può essere trovato nel \emph{\gl{Piano di Progetto V1.0.0}} all'interno della quarta sezione.  
