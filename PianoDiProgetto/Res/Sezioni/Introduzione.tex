...
Il prodotto da realizzare consiste in un \gl{plugin} per il software di monitoraggio \gl{Grafana}, da sviluppare in linguaggio \gl{JavaScript}. Il prodotto dovrà svolgere almeno le seguenti funzioni:
\begin{itemize}
...
\begin{itemize}
	...
	\item \textbf{Verbali:} \emph{Verbale del ???};
