...
\begin{itemize}
	...
	\item  \textbf{\gl{Swift} o \gl{Kotlin}}: linguaggi per lo sviluppo della mobile app.
\end{itemize}
\subsubsection{Valutazione generale}
\paragraph{Aspetti positivi}
\begin{itemize}
	...
	\subsection{Capitolato C6 - Soldino}
		...
		\subsubsection{Studio del dominio}
			...
			\begin{itemize}
				...
				\item \textbf{\gl{Raiden Network}}: soluzione per trasferimenti di \gl{token ERC-20} quasi istantanei;
