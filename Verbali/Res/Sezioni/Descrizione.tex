...
\begin{itemize}
	\item { \textbf{Strumenti di comunicazione team:} lo strumento che lo strumento che il gruppo utilizzerà per la comunicazione sarà \textit{\gl{Discord}}.}
...
Ogni membro del gruppo prima della riunione ha analizzato ciascun capitolato, traendone aspetti positivi e negativi. Successivamente è stato fatto un confronto collettivo, il quale ha portato alla scelta del capitolato C3, \emph{G\&B: monitoraggio intelligente di processi DevOps}, proposto dall'azienda Zucchetti.
