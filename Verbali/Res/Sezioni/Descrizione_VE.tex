...
\emph{Questo plug-in richiede due step: il primo prevede la realizzazione di una rete bayesiana attraverso un file \gl{JSON} che permette la configurazione. Cosa c'entra con i casi d'uso????????}
