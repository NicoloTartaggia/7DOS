...
Per vedere in dettaglio il diagramma delle classi relativo al buisness layer del plug-in consultare l'immagine \emph{Buisness Layer} consegnata in allegato al documento.
