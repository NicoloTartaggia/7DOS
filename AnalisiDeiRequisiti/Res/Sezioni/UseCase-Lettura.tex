...
\subsection{UC2.3.1: Inserimento nome file} 
\hypertarget{UC2.3.1}{} 
\begin{itemize} 
...
\subsection{UC2.3.2: Inserimento percorso file} 
\hypertarget{UC2.3.2}{} 
\begin{itemize} 
	\item{\textbf{Attori primari}: Utente;} 
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: il sistema notifica un messaggio d'errore causato da un salvataggio non andato a buon fine della configurazione dell'attuale configurazione di rete;
...
\subsection{UC2.6: Caricamento di un file non valido}
\hypertarget{UC2.6}{}
\begin{itemize}
	\item \textbf{Attori}: Utente;
