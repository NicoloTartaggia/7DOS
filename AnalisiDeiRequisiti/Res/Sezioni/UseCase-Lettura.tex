...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Scopo e descrizione}: L'attore configura la connessione tra la rete bayesiana e la sorgente dati con secondo le impostazioni descritte da un file salvato su disco;
