...
\begin{longtable}{|c|H|c|}
	...
	\hypertarget{R1F7.7}{R1F7.7} & Deve essere possibile gestire errori relativi al salvataggio del file JSON contenente la struttura della rete. & Interno \\ \hline 
	\hypertarget{R1F7.7.1}{R1F7.7.1} & Deve essere possibile gestire l’inserimento di valori non validi per il nome del file. & Interno \\ \hline 
	\hypertarget{R1F7.7.2}{R1F7.7.2} & Deve essere possibile gestire l’inserimento di valori non validi per per il percorso del file. & Interno \\ \hline 
	\hypertarget{R1F7.8}{R1F7.8} & Deve essere possibile gestire errori relativi alla modifica di un nodo. & Interno \\ \hline 
	\hypertarget{R1F7.8.1}{R1F7.8.1} & Deve essere possibile gestire l’inserimento di valori non validi per il nome di un nodo. & Interno \\ \hline 
	\hypertarget{R1F7.8.2}{R1F7.8.2} & Deve essere possibile gestire l’inserimento di valori non validi per il nome di uno stato associato alla CPT di un nodo della rete. & Interno \\ \hline 
	\hypertarget{R1F7.8.3}{R1F7.8.3} & Deve essere possibile gestire l’inserimento di valori non validi per l’intervallo associato ad uno stato del nodo. & Interno \\ \hline 
	\hypertarget{R1F7.8.4}{R1F7.8.4} & Deve essere possibile gestire l’inserimento di valori non validi per una cella della tabella. & Interno \\ \hline 
...
\hline
\hyperlink{R1F7.7}{R1F7.7} & \hyperlink{UC1.6}{UC1.6}\\
\hline
\hyperlink{R1F7.8}{R1F7.8} & \hyperlink{UC1.7}{UC1.7}\\
\hline
\hyperlink{R1F7.8.1}{R1F7.8.1} & \hyperlink{UC1.7.1}{UC1.7.1}\\
\hline
\hyperlink{R1F7.8.2}{R1F7.8.2} & \hyperlink{UC1.7.2}{UC1.7.2}\\
\hline
\hyperlink{R1F7.8.3}{R1F7.8.3} & \hyperlink{UC1.7.3}{UC1.7.3}\\
\hline
\hyperlink{R1F7.8.4}{R1F7.8.4} & 
\begin{tabular}{c}
...
\begin{longtable}{|c|c|}
	...
	\hline
	 \hyperlink{UC1.2.2}{UC1.2.2} & \hyperlink{R1F7.2}{R1F7.2}\\
	\hline
	\hyperlink{UC1.3}{UC1.3} & \hyperlink{R1F7.3}{R1F7.3}\\
	\hline
	\hyperlink{UC1.4}{UC1.4} & \hyperlink{R1F7.4}{R1F7.4}\\
	\hline
	\hyperlink{UC1.5}{UC1.5} & \hyperlink{R1F7.5}{R1F7.5}\\
	\hline
	\hyperlink{UC1.6}{UC1.6} & \hyperlink{R1F7.6}{R1F7.6}\\
	\hline
	\hyperlink{UC1.9}{UC1.9} & \hyperlink{R1F1.1}{R1F1.1}\\
	\hline
