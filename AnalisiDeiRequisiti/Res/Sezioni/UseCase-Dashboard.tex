...
\begin{itemize}
	...
	\item \textbf{Descrizione}: L'attore configura la disposizione dei panel nella \gl{dashboard};
	...
	\begin{itemize}
		...
		\item \gl{Minimizzazione} di un panel  (UC6.4).(TODO: DA INSERIRE???)
	\end{itemize}
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L'utente crea un panel (e ne configura i valori?) a scelta tra Graph, Singlestat Panel, Dashboard List Panel, Table Panel, Text Panel;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L’utente può spostare il panel dentro la dashboard;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L’utente può cancellare il panel dentro la dashboard;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L’utente può minimizzazione il panel dentro la dashboard;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L'attore configura e/o modifica le opzioni relative alla visualizzazione dei dati nei panel;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L'attore configura le opzioni relative alla visualizzazione dei dati nei panel;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L’utente può selezionare il flusso di dati dentro il panel;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L’utente può selezionare il nodo della rete bayesiana da visualizzare dentro il panel;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L’utente può selezionare l'intervallo di tempo da visualizzare dentro il panel;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L'attore modifica le opzioni relative alla visualizzazione dei dati nei panel;
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: L’utente può effettuare le modifiche standard previste da Grafana dentro il panel;
