...
\subsubsection{Qualità di processo}
	...
	\item \textbf {Livello 3 - Established Process}: il processo possiede specifici standard organizzativi che includono linee guida personalizzate, il tutto è consolidato tramite una politica di feedback del prodotto. Gli attributi di tale processo sono:
		\begin{itemize}
		\item \textbf{3.1 - Process Definition}: il processo specifico si base su processi standard, individuando e incorporando caratteristiche fondamentali di questi;
		\item \textbf{3.2 - Process Deployment}: il processo specifico è sviluppato basandosi su processi standard appropriatamente selezionati e, se necessario, adattati.
		\end{itemize}
...
\textbf{Sotto-caratteristiche notevoli}
\begin{itemize}
	\item{\textbf{Modularity}}: esprime il grado di scomposizione del sistema in parti minimali tali che un cambiamento ad uno specifica componente ha il minimo impatto su tutte le altri componenti;
...
\begin{itemize}
	\item {\textbf{Intervallo limite:} tutti i valori che la metrica può assumere;}
...
$$
\textbf{Intervallo limite}: nessuno \\	
\textbf{Intervallo accettabile}: 12-15;\\
\textbf{Intervallo obiettivo}: $\leq$12; 
...
I risultati sono compresi tra 0 e 100, dove 0 indica la leggibilità più bassa e 100 la leggibilità più alta. In generale risulta che i testi con indice:
	...
	\end{itemize}
\textbf{Intervallo limite}: 0-100; \\	
\textbf{Intervallo accettabile}: 40-100;\\
\textbf{Intervallo obiettivo}: 60-100; 
...
La leggibilità è considerata:
	...
	\end{itemize}
\textbf{Intervallo limite}: 0-100;
\textbf{Intervallo accettabile}: 50-100;\\	
\textbf{Intervallo obiettivo}: 60-100. 
...
\begin{itemize}
	\item{\textbf{Intervallo limite}: nessuno;}
