...
Le metriche utilizzate, definite nel documento \emph{Norme di Progetto v2.0.0}, sono le seguenti:
\begin{itemize}
	\item{MTS001 \emph{Percentuale test case passati};}
	\item{MTS002 \emph{Percentuale test case falliti};}
	\item{MTS003 \emph{Tempo medio necessario al team per risolvere un errore};}
	\item{MTS004 \emph{Efficienza nella progettazione dei test};}
	\item{MTS005 \emph{Percentuale di difetti corretti};}
	\item{MTS006 \emph{Percentuale test eseguiti};}
...
\subsubsection{Tabella riassuntiva delle metriche relative ai test}
\renewcommand{\arraystretch}{1.5}
\begin{table}[H]
	\centering
	\begin{tabular}{|C{3cm}|C{5cm}|C{4cm}|C{4cm}|}
		\hline
		\rowcolor{title_row}
		\textbf{\color{title_text}{ID Metrica}} &
		\textbf{\color{title_text}{Nome Metrica}} &  \textbf{\color{title_text}{Range accettabile}} & \textbf{\color{title_text}{Range ottimale}} \\ \hline
		MTS001 & Percentuale test case passati & 100\%  & 100\% \\ \hline
		MTS002 & Percentuale test case falliti & 0\% & 0\% \\ \hline
		MTS003 & Tempo medio necessario al team per risolvere un errore & 0h-4h & 0h-2h \\ \hline
		MTS004 & Efficienza nella progettazione dei test & 0.5h-3h & 0.5h-2h \\ \hline
		MTS005 & Percentuale dei difetti corretti & 90\%-100\% & 95\%-100\% \\ \hline
		MTS006 & Percentuale dei test eseguiti & 85\%-100\% & 95\%-100\% \\ \hline
	\end{tabular}
