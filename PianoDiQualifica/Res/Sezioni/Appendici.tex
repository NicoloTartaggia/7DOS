...
\begin{longtable}{|c|c|}
	...
	{R1F2.3} & Implementato\\
	\hline
	{R0F3} & Non implementato\\
	\hline
	{R1F3.1} & Implementato\\
	\hline
	{R0F4} & Non implementato\\
	\hline
	{R1F4.1} & Non implementato\\
	\hline
	{R0F5} & Implementato\\
	\hline
	{R1F5.1} & Implementato\\
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|c|c|p{6.8cm}|}
			...
			\hline
			{Gestione dei test} & {4} & {Sono stati specificati ed implementati buona parte dei test La copertura dei test di unità a registrato esiti molto positivi.}\\	
			\hline
...
La scarsa copertura delle funzionalità in ingresso alla fase di progetto ha fatto registrare valori non accettabili, ma grazie al lavoro del team questa metrica ha raggiunto un valore accettabile, anche se non ancora ottimale.
\begin{figure} [H]
	\centering
...
La presenza di alcune criticità in ingresso alla fase di progetto ha fatto registrare valori non accettabili, ma grazie al lavoro del team questa metrica ha raggiunto un valore accettabile, anche se non ancora ottimale.
\begin{figure} [H]
	\centering
...
La presenza di pochi commenti nel codice in ingresso alla fase di progetto ha fatto registrare dei valori non accettabili, ma con il lavoro del team questa metrica ha raggiunto un valore accettabile.
\begin{figure} [H]
	\centering
