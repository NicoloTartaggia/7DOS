...
\begin{longtable}{|C{2.5cm}|C{13cm}|}
	...
	\endhead
	\hline
	\rowcolor{ashgrey}{Unità} & NetReader - NetUpdater\\
	\hline
	{TI-1} &
	\begin{itemize}
...
expect(update_result[1]).to.be.between(0.58, 0.62);
	...
	\end{itemize} \\ 
	\hline \newpage	\hline
	\rowcolor{ashgrey}{Unità} &  NetUpdater - NetWriter\\
	\hline	
	{TI-2} &
	\begin{itemize}
...
expect(error).to.equal(false); 
	...
	\end{itemize} \\		
	\hline \newpage	\hline
	\rowcolor{ashgrey}{Unità} & NetManager: NetReader - NetUpdater - NetWriter\\
	\hline	
	{TI-3} & 
...
expect(writerError).to.equal(false); 
	...
	\end{itemize} \\		
	\hline \newpage	\hline
	\rowcolor{ashgrey}{Unità} & NetworkAdapter - NetUpdater \\
	\hline	
	{TI-4} & 
