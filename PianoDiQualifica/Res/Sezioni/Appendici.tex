...
\paragraph{Verifica e validazione} \Spazio
\renewcommand{\arraystretch}{1.5}
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|c|c|p{6.8cm}|}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & Datasource::copy
\\ \hline
{TU-91} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & Datasource::clone
\\ \hline
{TU-94} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getDatabase
\\ \hline
{TU-95} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getGrafanaDatasourceId
\\ \hline
{TU-96} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getHost
\\ \hline
{TU-97} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getName
\\ \hline
{TU-98} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getPassword
\\ \hline
{TU-99} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getPort
\\ \hline
{TU-100} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getType
\\ \hline
{TU-101} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getUrl
\\ \hline
{TU-102} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::getUsername
\\ \hline
{TU-103} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & DataSource::cloneWithDB
\\ \hline
{TU-103} &
\begin{itemize}
...
\end{itemize}\\
\hline
\rowcolor{ashgrey}{Scope} & NetReader::disconnectNode
\\ \hline
{TU-113} & 
\begin{itemize}
