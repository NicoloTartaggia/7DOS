...
\emph{G\&B} è un plug-in per il software di monitoraggio Grafana. Il suo scopo è estenderne le funzionalità permettendo di monitorare il sistema desiderato con una o più reti bayesiane definita ad-hoc dall'utente, consentendo poi la visualizzazione dei dati calcolati mediante i \gl{panel} di Grafana.
\\
