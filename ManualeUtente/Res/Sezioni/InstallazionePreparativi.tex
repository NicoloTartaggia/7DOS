...
ed copiarlo all'interno della cartella \texttt{/plugins} nella \gl{root folder} del server Grafana (nel caso tale cartella non fosse presente, il progetto dovrà essere copiato all'interno della cartella ~ \texttt{/data/plugins} ~).
